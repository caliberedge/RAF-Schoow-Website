...
// $status = mysql_real_escape_string($_GET['status']);
 //$amount = mysql_real_escape_string($_GET['amount']);
  ...
  $get_id = mysql_real_escape_string($_POST['transactionId']);
...
<li class=\"fa fa-check\"></li> <b>Payment for $child is Successful!</b> <a href=\"get_activate.php?inv=$recemail&cd=$code12\"> click here</a> to print the PINCODE RECEIPT.<br> OR
...
$recemail = $recemail, 'luckyisaiah@gmail.com';
...
$bodylink .= "please click on this link to fill the application form https://www.deeperlifehighschool.org/admission_form.php?rg=$codea";						
							
$message = 'Application Form Payment for ' . $child . ' was successful. Your PINCODE is: ' . $code12 . $bodylink . ' Thank You for Choosing Deeper Life High School.';	                        

$headers = 'From: noreply@deeperlifehighschool.org'; 

$headers = 'Cc: inquiry@deeperlifehighschool.com';
...
// mail ($recemail, "Deeper Life High School, Admission Form", $messages, $headers);			
