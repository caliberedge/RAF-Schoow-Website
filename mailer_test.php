...
?>
        ...
        <div class="contact-form loginWrp">
          ...
          <form id="contactForm" name="myForm" method="POST" action="fetch_code2.php" onsubmit="return validateForm()" novalidate="">
            <div class="row">
              <div class="col-lg-12 col-md-12">
                <div class="form-group">
                  <input type="text" name="transactionId" class="form-control" placeholder="Supply Ref Number" required>
                </div>
              </div>
              <div class="row">
              <div class="col-lg-12 col-md-12">
                <div class="form-group">
                  <input type="text" name="amount"  value="10" class="form-control" placeholder="amount" required>
                </div>
              </div>
              <div class="row">
              <div class="col-lg-12 col-md-12">
                <div class="form-group">
                  <input type="text" name="date" value="today" class="form-control" placeholder="Date" required>
                </div>
              </div>
             
                  <input type="hidden" name="status" value="success" class="form-control" placeholder="amount" required>
