...
2021/2022 FOURTH SUPPLEMENTARY ENTRANCE EXAM POSTING </h2>	<br>	</center>	
The list below contains the names and posting of candidates who succeeded in the recently conducted DLHS Common Entrance Examination and Interview (and who were not disqualified on the basis of age or other factors).
 Candidates whose names appear on this list should proceed to pay a <b>NON-REFUNDABLE Acceptance Registration Fee of ₦50,000.00 (fifty thousand naira) only by bank draft</b> in favour of Deeper Life High School on or before <b>Friday 10th September, 2021.
 ...
 The balance of school fees for the term is expected to be paid on or before the date of resumption. Please accept our congratulations.			<br>	<br>	
  <form name="myForm" id="myform" action="fourth_2021.php" method="POST">
...
$result = mysql_query("SELECT * FROM 2021_fourth_sup WHERE names like '%{$names}%'"); 
if ($result) {
