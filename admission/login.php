...
<div id="container">
<h1><strong>Deeper Life High School Admission process </strong></h1>
</head>
 
<body>
<h1 align=center>Supply your payment Details here</h1>
...
<form id="loginForm" name="loginForm" method="post" action="login-exec.php">
  <table width="300" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td width="300" colspan=2> <h1 align=center> Enter Details </h1> </td>
    </tr>
    <tr>
