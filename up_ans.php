...
$test_ID = mysqli_real_escape_string($connection,$_POST['test']);
$quest_ID = mysqli_real_escape_string($connection,$_POST['question_ID']);
$obt_mark = mysqli_real_escape_string($connection,$_POST['obtain_marks']);
$corr_ans = mysqli_real_escape_string($connection,$_POST['correct_ans']);
$std_ans = mysqli_real_escape_string($connection,$_POST['student_ans']);
                    ...
                    <div class="row">
                        ...
                        <form  method="GET" action="start_testt1.php" id="question_submit">
                               ...
                               // if (isset($_POST["next"])) { $page  = $_POST["next"]; } else { $page=1; };
                                //$start_from = ($page-1) * 1;
                                    $query = mysqli_query($connection,"SELECT * FROM question WHERE test_ID='$id' ORDER BY question_ID  LIMIT 1");
                             ...
                             // $result = $connection->query($query);
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <div class="question-title">
										...
										<?= $i ?>) <?= htmlspecialchars_decode($row['question'],ENT_QUOTES); ?>						
                                ...
                                <div class="form-group text-center" style="margin-top: 10px;">
                                    ...
                                    <tr>
<th style="width:12%;text-align:left;"><input type="submit" name="<?php if($i==$data['total']){ echo "submit" ;}else{ echo "next";} ?>" value="<?php if($i==$data['total']){ echo "submit" ;}else{ echo "next";} ?>" class="btn btn-primary"></th>                                   
