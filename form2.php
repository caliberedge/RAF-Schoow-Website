...
<form name="myForm" method="post" action="appformupdate.php" target="sundryframe" enctype="multipart/form-data" onsubmit="return validateForm()">
...
let y = document.forms["myForm"]["dchild"].value;
  ...
  let j = document.forms["myForm"]["sdfirst"].value;
  let k = document.forms["myForm"]["sdsecond"].value;
  if (j == k) {
