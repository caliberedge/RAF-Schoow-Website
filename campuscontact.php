...
<div class="innerHeading-wrap">
  <div class="container">
    <h1>Contact Us DLHS <?php echo " " . $row['title'] ; ?></h1>
...
$qry6 = "INSERT INTO web_contact(date, campus_ID, fname, lname, email, phone, msg, msg_state) VALUES(now(), '$campus_ID', '$fname', '$lname', '$email', '$phone', '$msg', 'unread')";
          ...
          <div class="contact-info login_box">
            <div class="contact-form loginWrp registerWrp">
              <form name="myForm" id="contactForm" onsubmit="return validateForm()" method="post" novalidate="">
                <h3>Get In Touch</h3>
                <input type="hidden" name="campus_ID" value="<?php echo $get_ID ;  ?>" class="form-control" placeholder="First Name">
                <div class="row">
                  <div class="col-lg-6">
