        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <?php if (isset($_SESSION['test_started']) && $_SESSION['test_started'] == $_GET['test']) { ?>
                        <form  method="GET" action="start_testtt1.php" id="question_submit">
                                <?php
                               // if (isset($_POST["next"])) { $page  = $_POST["next"]; } else { $page=1; };
                                //$start_from = ($page-1) * 1;
                                    $query = mysqli_query($connection,"SELECT * FROM question WHERE test_ID='$id' AND question_ID > $quest_ID LIMIT 1");
                                ...
                                while ($row = mysqli_fetch_array($query)) {
									...
									<div class="option-list col-lg-10">
                                            ...
                                            $order = 0;
                                                ...
                                                <p class=""><input type="radio" name="student_ans" class="question-radio" value="<?= trim($option) ?>">
