  ...
  <div class="container"> 
    ...
    <div class="login-wrap ">
      <div class="contact-info login_box">
        ...
        <h3>Portal Login </h3>
        <p>Login Failed, Make sure you enter corrcet Details</p>
        
        <div class="contact-form loginWrp">
          <h3>Supply Username and Password</h3>
          <p>Username and Password are case Sensitive .</p>
          <form id="contactForm" name="myForm" method="post" action="signin_exec.php" onsubmit="return validateForm()" novalidate="">
            <div class="row">
              ...
              <div class="col-lg-12 col-md-12">
                <div class="form-group">
                  <input type="password" name="passwords" class="form-control" placeholder="Supply Password" required>
                </div>
              </div>
