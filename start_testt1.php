...
$test_ID = mysqli_real_escape_string($connection,$_GET['test_ID']);
                    ...
                    <div class="row">
                        ...
                        <form  method="post" id="question_submit">
                               ...
                               // if (isset($_POST["next"])) { $page  = $_POST["next"]; } else { $page=1; };
                                //$start_from = ($page-1) * 1;
                                    $query = mysqli_query($connection,"SELECT * FROM question WHERE test_ID='$id' WHERE question_ID='$qn'  LIMIT 1");
