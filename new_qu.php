...
<?php if (isset($_SESSION['test_started']) && $_SESSION['test_started'] == $_GET['test']) { ?>
    <div class="text-center " id="timer-header"> 
        <span id="status"></span><span class="remain-time">  Remaining Time <?php echo $code = $test->d_minutes; ?></span>
    </div>
<?php } ?>
<?php
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <?php if (isset($_SESSION['test_started']) && $_SESSION['test_started'] == $_GET['test']) { ?>
                        <form action="test_submit2.php" method="post" id="question_submit">
                                <?php
                                     $query = mysqli_query($connection,"SELECT * FROM question WHERE test_ID='$id' LIMIT 1");
                              ...
                              //  $query = Question::get_question_by_test($_GET['test']);
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <div class="question-title">
										...
										<?= $i ?>) <?= htmlspecialchars_decode($row['question'],ENT_QUOTES); ?>	<?= $row['question_ID']; ?>							
                                ...
                                <div class="form-group text-center" style="margin-top: 10px;">
                                    ...
                                    <tr>
                      <th style="width:12%;text-align:left;"><input type="submit" id="submitted" name="submit" value="Next" class="btn btn-primary"></th>
                                            </tr>  
                                            <tr>
